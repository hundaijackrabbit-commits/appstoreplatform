...
export const PRODUCTS: Product[] = [
  {
    ...
    buildTime: { min: 2, max: 6, display: '3-5 business days' },
    features: [
      'Responsive Design',
    ...
    addons: [
      { id: 'premium-design', name: 'Premium Design Pack', description: 'Professional color schemes and typography', price: 79 },
      { id: 'testimonials', name: 'Testimonials Section', description: 'Social proof from customers', price: 49 },
      { id: 'pricing-table', name: 'Pricing Table', description: 'Display your pricing tiers', price: 79 },
      { id: 'blog-preview', name: 'Blog Preview Section', description: 'Recent blog posts showcase', price: 99 },
      { id: 'animations', name: 'Advanced Animations', description: 'Smooth transitions and effects', price: 149 }
    ]
  },
  {
    id: 'portfolio-pro',
    ...
    basePrice: 799,
    category: 'portfolio',
    buildTime: { min: 3, max: 8, display: '5-10 business days' },
    features: [
      'Project Gallery',
      'About Section', 
      'Contact Integration',
    ...
    addons: [
      { id: 'skills-showcase', name: 'Skills Showcase', description: 'Professional skills display', price: 99 },
      { id: 'blog', name: 'Blog Integration', description: 'Personal blog section', price: 199 },
      { id: 'cms', name: 'Content Management', description: 'Easy content updates via admin panel', price: 299 },
      { id: 'animations', name: 'Advanced Animations', description: 'Smooth portfolio transitions', price: 149 },
      { id: 'analytics', name: 'Analytics Dashboard', description: 'Track visitor metrics', price: 79 }
    ]
  },
  {
    id: 'saas-dashboard',
    ...
    basePrice: 1499,
    category: 'saas-tool',
    buildTime: { min: 12, max: 36, display: '2-4 weeks' },
    features: [
      'User Authentication',
      'Dashboard Analytics',
      'Data Tables',
    ...
    techStack: ['Next.js', 'TypeScript', 'Tailwind CSS'],
    addons: [
      { id: 'oauth', name: 'Social Authentication', description: 'Google, GitHub, Twitter login', price: 199 },
      { id: 'user-management', name: 'User Management', description: 'Manage application users', price: 299 },
      { id: 'billing', name: 'Billing Integration', description: 'Stripe payment processing', price: 50 },
      { id: 'notifications', name: 'Real-time Notifications', description: 'Live updates and alerts', price: 199 },
      { id: 'api-docs', name: 'API Documentation', description: 'Auto-generated API docs', price: 199 }
    ]
  },
  {
    id: 'ecommerce-store',
    ...
    addons: [
      ...
      { id: 'admin-dashboard', name: 'Admin Dashboard', description: 'Comprehensive admin panel', price: 299 },
      { id: 'customer-accounts', name: 'Customer Accounts', description: 'User registration and profiles', price: 199 },
      { id: 'reviews', name: 'Product Reviews', description: 'Customer review system', price: 149 },
  ...
  },
  {
    ...
    addons: [
      { id: 'headless-cms', name: 'Headless CMS', description: 'Visual content editor', price: 299 },
      { id: 'search', name: 'Search Functionality', description: 'Find posts quickly', price: 99 },
      { id: 'comments', name: 'Comment System', description: 'Reader engagement', price: 149 },
      { id: 'newsletter', name: 'Newsletter Integration', description: 'Email subscribers', price: 199 },
      { id: 'analytics', name: 'Analytics Dashboard', description: 'Track reader metrics', price: 149 }
    ]
  },
  {
    id: 'api-service',
    ...
    addons: [
      { id: 'file-upload', name: 'File Upload', description: 'Handle file uploads and storage', price: 199 },
      { id: 'search-filtering', name: 'Advanced Search', description: 'Advanced query capabilities', price: 299 },
      { id: 'notifications', name: 'Notification APIs', description: 'Email and push notifications', price: 35 },
      { id: 'webhooks', name: 'Webhook System', description: 'Event-driven notifications', price: 149 },
      { id: 'monitoring', name: 'Monitoring & Logging', description: 'Performance and error tracking', price: 199 }
    ]
  }
];
