          ...
          {PRODUCTS.slice(0, 6).map((product, index) => {
            const keyFeatures = Array.isArray(product.keyFeatures) && product.keyFeatures.length > 0
              ...
              : Array.isArray(product.features) && product.features.length > 0
                ...
                : ['Complete source code included', 'Mobile responsive design', 'Deployment-ready handoff'];
            const bestFor = product.bestFor || 'Entrepreneurs and small business owners';
            const buildTimeDisplay = product.buildTime?.display || 'Timeline confirmed after review';
